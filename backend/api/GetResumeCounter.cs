...
namespace Company.Function
{
    public static class GetResumeCounter
    {
        ...
        public static Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequest req,
                                                    ...
                                                    ILogger log)
        {
            ...
            return NewMethod(jsonToReturn);
        }

        private static Task<HttpResponseMessage> NewMethod(string jsonToReturn)
        {
